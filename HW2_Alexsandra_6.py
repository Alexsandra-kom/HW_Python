...
goods = []
while input("Хотите ли вы добавить продукт в список? Введите да/нет: ") == 'да':
    number = int(input("Введите номер продукта: "))
    features = {}
    while input("Хотите ли вы ввести парамерт продукта? Введите да/нет: ") == 'да':
        feature_key = input("Введите наименование характеристики: ")
