...
def my_sum():
    ...
    exc = False
    while not exc:
        number = input("Введите числа для суммирования через пробел или # для выхода >>> ").split()
        ...
        print(f'Текущая сумма равна - {result_sum}')
    print(f'Итоговая сумма равна - {result_sum}')
